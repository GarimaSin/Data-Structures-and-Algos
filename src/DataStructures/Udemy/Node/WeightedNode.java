...
import java.util.*;
import DataStructures.Udemy.DisjointSet.DisjointSet;


//Node class not the graph class
public class WeightedNode implements Comparable<WeightedNode> {
	public String name;
	public int intName;

	private ArrayList<WeightedNode> neighbors = new ArrayList<WeightedNode>();
	private HashMap<WeightedNode, Integer> weightMap = new HashMap<>();			//node as key and distance as value - to find node's neighbouring edge wts. 
