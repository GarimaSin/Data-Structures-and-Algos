...
class Key { 
	Integer freq; // store frequency of character 
	char ch; 
	Key(int val, char c) { 
		freq = val; 
		ch = c; 
...
// 		Insert all chars with their frequencies into a priority_queue 
//		PriorityQueue<Key> pq = new PriorityQueue<>((k1, k2) -> k2.freq.compareTo(k1.freq));	//Can replace KeyComparator class with this code 
