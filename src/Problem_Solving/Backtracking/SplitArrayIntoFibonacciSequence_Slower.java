...
public class SplitArrayIntoFibonacciSequence_Slower {
	...
	public  List<Integer> splitIntoFibonacci(String s, int pos, List<Integer> local, List<Integer> ans) {
		...
		for (int i = pos; i < s.length(); i++) {
			...
			if ((overFlow(substr))
					...
					|| (substr.length()>1 && substr.charAt(0)=='0'))
				break;
