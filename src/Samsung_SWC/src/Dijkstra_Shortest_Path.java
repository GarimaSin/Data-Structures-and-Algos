...
/**
 * Created by Dev Computer on 6/17/2015.
 */
public class Dijkstra_Shortest_Path {
    ...
    void dijkstra(int graph[][], int src)
    {
        ...
        boolean sptSet[] = new boolean[V]; // sptSet[i] will true if vertex i is included in shortest path tree or shortest distance from src to i is finalized
   ...
   /* Let us create the example graph discussed above */
        ...
        Dijkstra_Shortest_Path dj = new Dijkstra_Shortest_Path();
        dj.dijkstra(graph, 0);
    }
}
