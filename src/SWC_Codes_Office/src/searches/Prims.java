...
public class Prims
{
	...
	public void Prim( )
	{
		...
		boolean[] vis = new boolean[NNodes];	// Reach/unreach nodes
	 ...
	 There are NNodes-1 unvis nodes; so we can loop
	 NNodes-1 times and UnReachSet will become empty !
	 =====================================================  */
		for (k = 1; k < NNodes; k++)
		{
			/* ================================================================
	    Find min. cost link between: vis node ---> unvis node
            ================================================================ */
			x = y = 0;
	...
	void printReachSet(boolean[] vis )
	{
